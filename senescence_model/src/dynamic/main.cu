...
void runConsoleWithXMLOutput(int iterations, int outputFrequency){
	...
	for (int i=0; i< iterations || iterations == 0; i++)
	{
		...
		if((i+1) % outputFrequency == 0){
			saveIterationData(outputpath, i+1, get_host_A_moving_A_agents(), get_device_A_moving_A_agents(), get_agent_A_moving_A_count(),get_host_A_change_direction_A_agents(), get_device_A_change_direction_A_agents(), get_agent_A_change_direction_A_count(),get_host_A_get_going_again_A_agents(), get_device_A_get_going_again_A_agents(), get_agent_A_get_going_again_A_count(),get_host_B_moving_B_agents(), get_device_B_moving_B_agents(), get_agent_B_moving_B_count(),get_host_B_change_direction_B_agents(), get_device_B_change_direction_B_agents(), get_agent_B_change_direction_B_count(),get_host_B_get_going_again_B_agents(), get_device_B_get_going_again_B_agents(), get_agent_B_get_going_again_B_count());
	...
	if(iterations % outputFrequency != 0){
		saveIterationData(outputpath, iterations, get_host_A_moving_A_agents(), get_device_A_moving_A_agents(), get_agent_A_moving_A_count(),get_host_A_change_direction_A_agents(), get_device_A_change_direction_A_agents(), get_agent_A_change_direction_A_count(),get_host_A_get_going_again_A_agents(), get_device_A_get_going_again_A_agents(), get_agent_A_get_going_again_A_count(),get_host_B_moving_B_agents(), get_device_B_moving_B_agents(), get_agent_B_moving_B_count(),get_host_B_change_direction_B_agents(), get_device_B_change_direction_B_agents(), get_agent_B_change_direction_B_count(),get_host_B_get_going_again_B_agents(), get_device_B_get_going_again_B_agents(), get_agent_B_get_going_again_B_count());
		printf("Iteration %i Saved to XML\n", iterations);
	}
